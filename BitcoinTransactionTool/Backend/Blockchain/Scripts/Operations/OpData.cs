...
{
    /// <summary>
    /// All the functions in this class skip checks (eg. checking ItemCount before popping an item)
    /// because the functions are called internally in an IOperations which does all these checks before calling these functions.
    /// </summary>
    public class OpData : IOpData
    {
        ...
        internal Transaction PrvTx;
        //internal EllipticCurveCalculator Calc;
        internal int TxInIndex;
        internal int TxOutIndex;
